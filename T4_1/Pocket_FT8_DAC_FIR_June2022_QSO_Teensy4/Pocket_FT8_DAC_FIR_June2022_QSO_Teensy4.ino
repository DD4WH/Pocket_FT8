...
AudioConnection          c2(Hilbert45_I, 0, amp1, 0); 
...
AudioConnection          patchCord4(sine1, amp2);
AudioConnection          patchCord10(amp2, 0, pt8211_1, 0);
AudioConnection          patchCord11(amp2, 0, pt8211_1, 1);
...
byte SD_Month, SD_Day, SD_Hour, SD_Minute, SD_Second, SD_Flag;
  ...
  char string[12];   // print format stuff
  sprintf(string,"%2i:%2i:%2i:%2i",gps_hour, gps_minute, gps_second, gps_hundred);
